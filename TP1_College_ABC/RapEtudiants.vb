...
Public Class RapEtudiants
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TP1_College_ABC.RapEtudiants.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRapEtudiants
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RapEtudiants = New RapEtudiants()
        rpt.Site = Me.Site
        Return rpt
    End Function
