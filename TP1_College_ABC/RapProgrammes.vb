...
Public Class RapProgrammes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TP1_College_ABC.RapProgrammes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRapProgrammes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RapProgrammes = New RapProgrammes()
        rpt.Site = Me.Site
        Return rpt
    End Function
